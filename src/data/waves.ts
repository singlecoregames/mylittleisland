...
export const WAVE_PHASES: WavePhase[] = [
  { atMin: 0, intervalMs: 1100, batch: 1, weights: { grunt: 100 } },
  { atMin: 0.5, intervalMs: 950, batch: 1, weights: { grunt: 100, charger: 40 } },
  { atMin: 1, intervalMs: 850, batch: 1, weights: { grunt: 90, charger: 45, splitter: 30 } },
  {
    atMin: 1.5,
    intervalMs: 760,
    batch: 1,
